...
class EmailConfig(BaseSettings):
    ...
    smtp_host: str = Field(default="mail.healthpartners.org")
    smtp_port: int = Field(default=25)
    smtp_from: str = Field(default="EDMDINotifications@hpplans.com")
    smtp_timeout: int = Field(default=30)
    default_recipient: str = Field(default="canadaphone4016@gmail.com")
